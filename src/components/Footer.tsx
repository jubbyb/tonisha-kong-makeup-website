    ...
    >
        ...
        <div>
          ...
          <div style={{ display: 'flex', gap: '1.25rem', marginTop: '1.5rem', alignItems: 'center' }}>
            <a
              ...
              style={{ color: 'var(--tk-text-footer)', transition: 'color 0.2s' }}
              onMouseEnter={(e) => ((e.currentTarget as HTMLElement).style.color = 'var(--tk-gold)')}
              onMouseLeave={(e) => ((e.currentTarget as HTMLElement).style.color = 'var(--tk-text-footer)')}
            >
      ...
      >
        ...
        <p
          style={{
            fontSize: '0.65rem',
            color: 'var(--tk-text-footer-dimmer)',
            letterSpacing: '0.1em',
            textTransform: 'uppercase',
          }}
        >
