...
export default function Survey() {
  ...
  const [status, setStatus] = useState<'loading' | 'ready' | 'submitted' | 'error' | 'not_found'>(
    'loading',
  );
  ...
  return (
    <div style={containerStyle}>
      <div style={cardStyle}>
        ...
        <p style={{ color: 'var(--ink-2)', lineHeight: 1.7, marginBottom: '0.25rem' }}>
          {meta?.service}
        </p>
        <p style={{ color: 'var(--ink-2)', fontSize: '0.8rem', marginBottom: 0 }}>
          {formattedDate}
        </p>
